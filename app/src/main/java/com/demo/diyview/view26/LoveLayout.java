...
public class LoveLayout extends RelativeLayout {
    ...
    public LoveLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        random = new Random();
        drawables = new Drawable[]{getResources().getDrawable(R.drawable.wait), getResources().getDrawable(R.drawable.two), getResources().getDrawable(R.drawable.three)};
    ...
    public void addImageView() {
        ...
        bezierAnimotion.setInterpolator(mInterpolators[random.nextInt(mInterpolators.length-1)]);
