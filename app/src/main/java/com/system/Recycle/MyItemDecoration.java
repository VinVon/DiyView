...
public class MyItemDecoration extends BaseDecoration {
    @ColorInt
    ...
    public MyItemDecoration(GroupListener groupListener) {
        super();
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (currentGroupName == null || TextUtils.equals(currentGroupName, preGroupName)) {
                ...
                Log.e("TAG",currentGroupName+"mGroupHeight:"+mGroupHeight+"===="+"view.getTop():"+view.getTop());
                if (position + 1 < itemCount) {
                    //获取下个GroupName
                    String nextGroupName = getGroupName(position + 1);
                    //下一组的第一个View接近头部
                    int viewBottom = view.getBottom();
                    Log.e("TAG",currentGroupName+"viewBottom:"+viewBottom+"===="+"bottom:"+bottom);
...
//根据前一个组名，判断当前是否为新的组
    ...
    public static class Builder {
        ...
        private Builder(GroupListener groupListener) {
            mDecoration = new MyItemDecoration(groupListener);
        }
